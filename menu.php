 <?php   
 session_start();  
 $connect = mysqli_connect("localhost", "root", "", "foodlogin");  
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center" style="color:white;">Choose Your Favourite Meal</h3><br />  
                <?php  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td style="color:white;"><a href="menu.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
